...
def sim_positive_pairs(out_left, out_right):
    ...
    # print('shape of pos pairs: ', pos_pairs.size())
    # print(pos_pairs)
    N = out_left.size(0)
    pos_pairs = pos_pairs.reshape(N,1)
...
def compute_sim_matrix(out):
    ...
    sim_matrix = out @ out.T /torch.outer(norm, norm)  # why??
...
def simclr_loss_vectorized(out_left, out_right, tau, device='cuda'):
    ...
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    pos_pair_sim = sim_matrix[torch.arange(0, N),torch.arange(N, 2*N)].reshape(-1,1) #[:,None]
